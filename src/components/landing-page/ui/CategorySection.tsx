...
export function CategorySection() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-line bg-surface py-20 sm:py-24 lg:py-28">
      ...
      <motion.div
        className="pointer-events-none absolute -right-32 top-20 h-80 w-80 rounded-full bg-brand/8 blur-3xl"
        animate={
          reduceMotion
            ? undefined
            : {
      ...
      <motion.div
        className="pointer-events-none absolute -left-40 bottom-0 h-72 w-72 rounded-full bg-pine/5 blur-3xl"
        animate={
          reduceMotion
            ? undefined
            : {
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        >
          <div className="max-w-2xl">
            ...
            >
              Find trusted Bhutanese businesses and services across Australia,
              or share what you offer with the community.
            </motion.p>
          </div>

          <Link
            href="/services"
            className="group hidden shrink-0 items-center gap-2 rounded-full border border-line bg-background px-5 py-2.5 text-sm font-medium text-ink transition-all duration-200 hover:border-brand/40 hover:bg-brand md:inline-flex"
          >
            View all services
        ...
        <motion.div
          ...
          className="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-3 lg:grid-cols-6"
        >
